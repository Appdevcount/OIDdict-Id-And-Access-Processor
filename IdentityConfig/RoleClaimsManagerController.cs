...
namespace Identity_And_Access_Management.IdentityManagement
{
    ...
    public class RoleClaimsManagerController : Controller
    {
        private readonly SignInManager<ApplicationUser> _signInManager;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly RoleManager<IdentityRole> _roleManager;

        public RoleClaimsManagerController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, RoleManager<IdentityRole> roleManager)
        {
        ...
        private async Task<List<string>> GetRoleClaims(ApplicationUser user)
        {
